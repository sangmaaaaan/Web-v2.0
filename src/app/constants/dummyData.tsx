export const dummyText = [
  ...
  export const dummyQuestion = [
    { id: 1, text: "HDFS가 데이터 손실을 방지하기 위해 유지하는 것은 고가용성이다." },
    { id: 2, text: "액티브-액티브 모드는 최소 3개의 노드를 필요로 한다." },
    { id: 3, text: "스파크는 __ 환경에서 동작한다." },
    { id: 4, text: "스파크 SQL이 쿼리 성능을 최적화하기 위해 사용하는 것은 Catalyst 옵티마이저이다." },
...
export const dummyExplanation = [
    { id: 1, text: "HDFS는 데이터를 복제하여 고가용성을 유지하며, 데이터 손실을 방지합니다." },
    { id: 2, text: "액티브-액티브 모드는 다수결을 통해 합의를 이루며, 최소 3개의 노드를 필요로 합니다." },
    { id: 3, text: "Catalyst 옵티마이저는 스파크 SQL의 핵심 구성 요소 중 하나로, 쿼리 성능을 최적화하는 역할을 합니다." },
    { id: 4, text: "스파크 SQL은 스파크 스트리밍과 통합되어 실시간 데이터 처리를 지원합니다." }
];